    ...
    <div class="col s12">
        <div class="card">
            <div class="card-content #e0f7fa cyan lighten-5">
                <center><span class="card-title">DETALLE VENTA</span></center>
                <p>ALTA DE DETALLES VENTA</p>
                <div class="input-field">
                    <input type="text" name="detalleventa" required autofocus 
                           title="DEBE DE CONTENER ENTRE 8 Y 15 CARACTERES, SOLO LETRAS" 
                           pattern="[A-Za-z]{8,15}" 
                           id="detalleventa" onblur="may(this.value, this.id)">
                    <label for="detalleventa">Detalle venta:</label>
                </div>
